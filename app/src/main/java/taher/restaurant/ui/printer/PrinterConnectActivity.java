package taher.restaurant.ui.printer;
...
import taher.restaurant.ui.ConfirmOrderActivity;
            ...
            case R.id.btnPrinterOpen:
                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (ConfirmOrderActivity.Companion.getBxlPrinter().printerOpen(portType, logicalName, address, checkBoxAsyncMode.isChecked())) {
                            finish();
                        } else {
